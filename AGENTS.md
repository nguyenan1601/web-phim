...
This project is indexed by GitNexus as **web-phim** (621 symbols, 1366 relationships, 50 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/web-phim/context` | Codebase overview, check index freshness |
| `gitnexus://repo/web-phim/clusters` | All functional areas |
| `gitnexus://repo/web-phim/processes` | All execution flows |
| `gitnexus://repo/web-phim/process/{name}` | Step-by-step execution trace |
