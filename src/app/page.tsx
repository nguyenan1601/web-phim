          ...
          <div className="container relative mx-auto px-4 z-10 pt-16">
            <div className="max-w-3xl space-y-5">
              ...
              <div className="flex flex-wrap items-center gap-3 text-sm md:text-base text-zinc-300 font-medium">
                ...
                <span className="text-amber-400 px-2 py-0.5 rounded bg-amber-500/10 border border-amber-500/20">
                  {heroMovie.quality}
                </span>
                <span className="w-1.5 h-1.5 rounded-full bg-zinc-600"></span>
              ...
              <div className="flex items-center gap-4 pt-6">
                <Link
                  ...
                  className="px-8 py-3.5 rounded-full bg-white text-black font-semibold hover:bg-amber-400 hover:scale-105 active:scale-95 transition-all flex items-center gap-2 shadow-xl shadow-white/10"
                >
